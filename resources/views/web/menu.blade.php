    ...
    <div class="container-fluid" style="height: 60px;padding-top: 5px">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li style="cursor: hand"><a ng-click="gotoElement('Products')" TARGET="_self">Our Products</a></li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
              <!--   @if (Auth::guest())
                ...
                @endif -->
                 <li  style="cursor: hand"><a ng-click="gotoElement('Contact')" TARGET="_self">Contact Us</a></li>
            </ul>
